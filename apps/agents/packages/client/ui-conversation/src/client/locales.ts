...
export const zh = {
  ...
  'hero.greeting': '嗨，新朋友！',
  'hero.question': '今天一起创作点什么？',
  'hero.preview': '预览版',
  'hero.suggestion.memory.title': '记忆',
  'hero.suggestion.memory.body': '帮我建立这个项目的创作记忆',
  'hero.suggestion.memory.detail': '记录项目主题、风格、关系和禁区。',
  'hero.suggestion.memory.prompt': '帮我建立这个项目的创作记忆，记录项目主题、风格、关系和禁区。',
  'hero.suggestion.next.title': '下一步',
  'hero.suggestion.next.body': '继续推进这个项目的下一步',
  'hero.suggestion.next.detail': '沿着已有故事、画面或风格继续推进。',
  'hero.suggestion.next.prompt': '请根据当前画布和项目进度，建议并执行下一步。',
  'hero.nav.toggleSidebar': '展开或收起侧边栏',
  'hero.nav.newSession': '新建对话',
  'hero.nav.status': '历史会话',
  'history.title': '历史会话',
  'history.close': '关闭历史会话',
  'history.empty': '当前画布暂无历史会话',
  'hero.nav.add': '聚焦输入框',
  'hero.nav.fullscreen': '切换全屏',
  'hero.nav.settings': '设置',
...
export const en = {
  ...
  'hero.greeting': 'Hi, new Tapper!',
  'hero.question': 'What shall we create today?',
  'hero.preview': 'Preview',
  'hero.suggestion.memory.title': 'Memory',
  'hero.suggestion.memory.body': 'Build creative memory for this project',
  'hero.suggestion.memory.detail': 'Record the project theme, style, relationships, and boundaries.',
  'hero.suggestion.memory.prompt': 'Build creative memory for this project, including its theme, style, relationships, and boundaries.',
  'hero.suggestion.next.title': 'Next step',
  'hero.suggestion.next.body': 'Keep moving this project forward',
  'hero.suggestion.next.detail': 'Continue from the existing story, visuals, or style.',
  'hero.suggestion.next.prompt': 'Review the current canvas and project progress, then recommend and execute the next step.',
  'hero.nav.toggleSidebar': 'Toggle sidebar',
  'hero.nav.newSession': 'New conversation',
  'hero.nav.status': 'Conversation history',
  'history.title': 'Conversation history',
  'history.close': 'Close conversation history',
  'history.empty': 'No conversation history for this canvas',
  'hero.nav.add': 'Focus composer',
  'hero.nav.fullscreen': 'Toggle fullscreen',
  'hero.nav.settings': 'Settings',
