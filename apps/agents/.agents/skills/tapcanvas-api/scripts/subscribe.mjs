 ...
 *
 * 用法：
 *   node .agents/skills/tapcanvas-api/scripts/subscribe.mjs --flowId <id> [--timeout 60]
 *   node .agents/skills/tapcanvas-api/scripts/subscribe.mjs --projectId <id> [--timeout 60]
 *   node .agents/skills/tapcanvas-api/scripts/subscribe.mjs --chapterId <id> [--timeout 60]
 *   node .agents/skills/tapcanvas-api/scripts/subscribe.mjs --executionId <id> [--after 0] [--timeout 60]
 *
