...
var defaultCacheRatio = map[string]float64{
	...
	// DeepSeek V4 错峰价：缓存读取与输入价格之比均为 1/30。
	"deepseek-v4-flash":                   1.0 / 30.0,
	"deepseek-v4-pro":                     1.0 / 30.0,
...
var defaultCreateCacheRatio = map[string]float64{
	// 火山方舟 Doubao Seed 2.0 的上下文缓存按命中 token 与缓存存储时长计费，
	// 不存在 Claude 风格的 cache creation token 单价。显式设为 0，避免落入 1.25 默认值。
	"doubao-seed-2-0-pro-260428":          0,
	"doubao-seed-2.0-pro":                 0,
	"doubao-seed-2-0-lite-260428":         0,
	"doubao-seed-2-0-lite-260215":         0,
	"doubao-seed-2.0-lite":                0,
	"doubao-seed-2-0-mini-260428":         0,
	"doubao-seed-2.0-mini":                0,
